...
public class RocketController extends WorldController implements ContactListener {
	...
	public void update(float dt) {
		...
		InputController control = InputController.getInstance();
		float horizontal = control.getHorizontal();
		float vertical = control.getVertical();

		rocket.setFX(horizontal * rocket.getThrust());
		rocket.setFY(vertical * rocket.getThrust());
